...
**Answer:**  
we don't manage servers directly. The cloud provider handles infrastructure and automatically scales resources. We mainly manage code and configuration, and billing is based on actual usage. Example:  AWS Lambda Azure Functions Google Cloud Functions
